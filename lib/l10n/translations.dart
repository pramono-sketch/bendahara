...
class Translations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    ...
    'en': {
      ...
      'total_school_balance': 'Total School Balance',
      'income_statistics_6_months': 'Income Statistics (6 Months)',
      'student_payment_status': 'Student Payment Status',
      'financial_insight': 'Financial Insight',
      'students_paid': 'Paid Students',
      ...
      'insight_paid_good': '✅ {percent}% of students have paid in full. Great!',
      'insight_paid_medium':
      ...
      'insight_income_stable': '➖ This month\'s income is stable.',
      'insight_income_new': '💰 There is new income this month.',
      ...
      'insight_balance_even': '⚖️ Balance is even.',
      ...
      'yearly': 'Yearly',
      'all_reports': 'All',
      'export_development': 'Export {format} is under development',
      'export_pdf': 'Export PDF',
      'export_excel': 'Export Excel',
      'no_monthly_report_data': 'No monthly report data yet.',
      'no_yearly_report_data': 'No yearly report data yet.',
      'no_all_report_data': 'No report data yet.',
      'year_label': 'Year',
      'total_overall': 'Overall Total',
      ...
      'firebase_data_error': 'Failed to read Firebase data',
      ...
      'paid_off': 'Paid off',
      'archive_data_error': 'Failed to read student archive',
      'archive_major_error': 'Failed to read archived majors',
      'archive_student_error': 'Failed to read archived students',
      ...
      'easter_egg_found': 'Congratulations! You found the Easter Egg! 🥚',
      ...
      'log_activity_title': 'Activity Log',
      'category': 'Category',
      'search_activity_hint': 'Search activity, user, or detail...',
      'cat_all': 'All',
      'cat_students': 'Students',
      'cat_transactions': 'Transactions',
      'cat_digital_account': 'Digital Account',
      'cat_payment': 'Payment',
      'cat_login_logout': 'Login/Logout',
      'cat_system': 'System',
      'no_activity_logs': 'No activity logs yet',
      'no_matching_logs': 'No matching logs',
      'showing_count': 'Showing {shown} of {total} activities',
      'log_read_error': 'Error reading activity logs',
      'just_now': 'Just now',
    ...
    'id': {
      ...
      'balance_summary': 'RINGKASAN SALDO',
      'total_school_balance': 'Total Saldo Sekolah',
      'income_statistics_6_months': 'Statistik Pemasukan (6 Bulan)',
      'student_payment_status': 'Status Pembayaran Siswa',
      'financial_insight': 'Insight Keuangan',
      'students_paid': 'Siswa Lunas',
      ...
      'insight_paid_good': '✅ {percent}% siswa sudah lunas. Bagus!',
      'insight_paid_medium':
      ...
      'insight_income_stable': '➖ Pemasukan bulan ini stabil.',
      'insight_income_new': '💰 Bulan ini mulai ada pemasukan baru.',
      'insight_balance_positive':
          '💚 Saldo positif: Rp {amount}. Keuangan sehat.',
      'insight_balance_negative':
          '🔴 Saldo negatif: Rp {amount}. Perhatikan pengeluaran.',
      'insight_balance_even': '⚖️ Saldo impas.',
      ...
      'month_june_short': 'Jun',
      'month_july_short': 'Jul',
      'month_august_short': 'Agu',
      'month_september_short': 'Sep',
      'month_october_short': 'Okt',
      'month_november_short': 'Nov',
      'month_december_short': 'Des',
      ...
      'yearly': 'Tahunan',
      'all_reports': 'Semua',
      'export_development': 'Export {format} sedang dalam pengembangan',
      'export_pdf': 'Export PDF',
      'export_excel': 'Export Excel',
      'no_monthly_report_data': 'Belum ada data laporan bulanan.',
      'no_yearly_report_data': 'Belum ada data laporan tahunan.',
      'no_all_report_data': 'Belum ada data laporan.',
      'year_label': 'Tahun',
      ...
      'firebase_data_error': 'Gagal membaca data Firebase',
      ...
      'paid_off': 'Melunasi',
      'archive_data_error': 'Gagal membaca arsip siswa',
      'archive_major_error': 'Gagal membaca jurusan arsip',
      'archive_student_error': 'Gagal membaca siswa arsip',
      ...
      'simulation_data': 'Simulasi Data',
      'transaction_type': 'Jenis',
      'description': 'Deskripsi',
      'amount_rupiah': 'Jumlah (Rp)',
      'cancel': 'Batal',
      'save': 'Simpan',
      'failed_add_transaction': 'Gagal menambah transaksi',
      ...
      'easter_egg_found': 'Selamat! Anda menemukan telur Paskah! 🥚',
      ...
      'log_activity_title': 'Log Aktivitas',
      'category': 'Kategori',
      'search_activity_hint': 'Cari aktivitas, pengguna, atau detail...',
      'cat_all': 'Semua',
      'cat_students': 'Siswa',
      'cat_transactions': 'Transaksi',
      'cat_digital_account': 'Akun Digital',
      'cat_payment': 'Pembayaran',
      'cat_login_logout': 'Login/Logout',
      'cat_system': 'Sistem',
      'no_activity_logs': 'Belum ada log aktivitas',
      'no_matching_logs': 'Tidak ada log yang sesuai',
      'showing_count': 'Menampilkan {shown} dari {total} aktivitas',
      'log_read_error': 'Terjadi error saat membaca log',
      'just_now': 'Baru saja',
