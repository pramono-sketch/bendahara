...
class _StudentsPageState extends ConsumerState<StudentsPage> {
  ...
  // Gunakan nilai internal tetap agar tidak rusak ketika bahasa berubah.
  static const String _allClassFilter = '__ALL_CLASSES__';

  String _filterKelas = _allClassFilter;

  // ==========================================================
  // FIRESTORE - SISWA AKTIF
  // Dikembalikan ke pola dari versi GitHub
  // ==========================================================
...
class _ArchiveRootPageState extends ConsumerState<ArchiveRootPage> {
  ...
  // ==========================================================
  // FIRESTORE - ARSIP FOLDER
  // Dikembalikan ke pola GitHub
  // ==========================================================
    ...
    if (amount >= totalRemaining) {
      ...
      if (surplus > 0) {
        ...
        _log(
          ...
          'surplus Rp ${formatCurrency(surplus)} '
          '${t('went_to_savings')}',
        );
      } else {
        _addTransaction(
