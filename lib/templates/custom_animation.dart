// lib/templates/costum_animation.dart
...
class LottieLoading extends StatelessWidget {
  final double size;
  const LottieLoading({super.key, this.size = 150.0});
...
class LottieError extends StatelessWidget {
  ...
  const LottieError({super.key, this.size = 200.0, this.message});
...
class LottieAiAnimation extends StatelessWidget {
  final double size;
  const LottieAiAnimation({super.key, this.size = 180.0});
...
class LottieBenefits extends StatelessWidget {
  final double size;
  const LottieBenefits({super.key, this.size = 180.0});
...
class LottieGameController extends StatelessWidget {
  final double size;
  const LottieGameController({super.key, this.size = 150.0});
...
class LottieLoadingCircle extends StatelessWidget {
  final double size;
  const LottieLoadingCircle({super.key, this.size = 100.0});
...
class LottieSplash extends StatelessWidget {
  final double size;
  const LottieSplash({super.key, this.size = 250.0});
...
void showTopNotification(BuildContext context, String message, {Color color = Colors.redAccent}) {
